...
class Home extends Component {
    render() {
        return (
            <div className='border-[1px] mx-3 cursor-cell p-3 min-w-[400px]  rounded-[30px] border-[#7a8085] flex-col justify-center'>
             ...
             <div className='border-[1px] my-3 cursor-cell p-3 py-9 rounded-[5px] border-[#7a8085] flex flex-wrap justify-center'>
                <div className='max-w-[300px] px-3'>
                <p className='flex justify-center text-2xl'>A WEB DEVELOPER AND UI/UX DESIGNER</p>
                ...
                <div>
                <img src={Image2} alt=""  className='rounded-[10px] w-[250px] my-3 border-[1px] border-[#7a8085] mx-auto'  />
                </div>
             </div>
           </div>
